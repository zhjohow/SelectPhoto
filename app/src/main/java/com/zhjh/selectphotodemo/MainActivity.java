package com.zhjh.selectphotodemo;
...
import com.zhjh.selectphoto.adapter.GridAdapter;
import com.zhjh.selectphoto.custom.CustomScrollGridView;
import com.zhjh.selectphoto.utils.CommandPhotoUtil;
import com.zhjh.selectphoto.utils.PhotoSystemOrShoot;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zhjh.selectphoto.R.layout.activity_main);
     ...
     */
    private void initUI() {
        mGridView = (CustomScrollGridView) findViewById(com.zhjh.selectphoto.R.id.gv_all_photo);
    }
